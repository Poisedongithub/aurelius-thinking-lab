        ...
        {type === "ticker" ? (
          <>
            <div className="flex items-baseline gap-3">
              <span className="text-xl font-bold font-mono text-white">{data.symbol}</span>
              <span className="text-xs font-mono text-white/40">{data.name}</span>
            </div>
            <div className="flex items-baseline gap-3 mt-2">
              <span className="text-2xl font-bold font-mono text-white">${data.price?.toFixed(2)}</span>
          ...
          <>
            <div className="text-xs font-mono text-white/40 mb-1">PORTFOLIO VALUE</div>
            <div className="text-2xl font-bold font-mono text-white">${data.totalValue?.toLocaleString()}</div>
