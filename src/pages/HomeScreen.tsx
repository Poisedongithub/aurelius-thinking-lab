...
const HomeScreen = () => {
  ...
  const cards = [
    { title: "Choose Opponent", desc: "Select your philosophical challenger", action: () => navigate("/arena"),
      ...
      icon: (<svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><line x1="6" y1="20" x2="18" y2="4"/><line x1="18" y1="20" x2="6" y2="4"/><line x1="15" y1="4" x2="18" y2="4"/><line x1="18" y1="4" x2="18" y2="7"/><line x1="6" y1="4" x2="9" y2="4"/><line x1="6" y1="4" x2="6" y2="7"/><line x1="9" y1="15" x2="15" y2="15"/></svg>) },
    { title: "Library", desc: "Explore philosophical concepts", action: () => navigate("/library"),
      ...
      icon: (<svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M2 4c2-1 4.5-1 7 0 2.5 1 3 1 3 1v15s-.5 0-3-1c-2.5-1-5-1-7 0V4z"/><path d="M22 4c-2-1-4.5-1-7 0-2.5 1-3 1-3 1v15s.5 0 3-1c2.5-1 5-1 7 0V4z"/></svg>) },
    { title: "Daily Challenge", desc: "Today's philosophical question", action: () => navigate("/dilemma"),
      ...
      icon: (<svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/><circle cx="12" cy="12" r="1" fill="currentColor"/></svg>) },
    { title: "Moral Court", desc: "Judge today's ethical case", action: () => navigate("/court"),
      ...
      icon: (<svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M12 3L3 8v2h18V8L12 3z"/><line x1="5" y1="10" x2="5" y2="18"/><line x1="9" y1="10" x2="9" y2="18"/><line x1="15" y1="10" x2="15" y2="18"/><line x1="19" y1="10" x2="19" y2="18"/><path d="M2 18h20v3H2z"/></svg>) },
  ];
